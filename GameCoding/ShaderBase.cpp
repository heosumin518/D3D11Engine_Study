...
VertexShader::VertexShader(ComPtr<ID3D11Device> device): ShaderBase(device)	// 상위 객체에 디바이스를 넘겨준다.
{
}
...
PixelShader::PixelShader(ComPtr<ID3D11Device> device): ShaderBase(device)
{
}
