...
PBRBRDF::PBRBRDF(const int32& width, const int32& height, const std::wstring& name)
...
void PBRBRDF::CreateInputLayout()
{
...
void PBRBRDF::CreateConstantBuffer()
{
