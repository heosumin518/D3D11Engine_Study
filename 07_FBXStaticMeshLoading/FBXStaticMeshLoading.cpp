...
void FBXStaticMeshLoading::CreateGeometry()
{
	// Vertex Data 준비
...
void FBXStaticMeshLoading::CreateShaderResourceView()
{
	...
	HR_T(CreateWICTextureFromFile(m_device.Get(), L"../Resources/Bricks059_1K-JPG_Color.jpg", nullptr, m_diffuseRV.GetAddressOf()));
	HR_T(CreateWICTextureFromFile(m_device.Get(), L"../Resources/Bricks059_1K-JPG_NormalDX.jpg", nullptr, m_normalRV.GetAddressOf()));
	HR_T(CreateWICTextureFromFile(m_device.Get(), L"../Resources/Bricks059_Specular.png", nullptr, m_specularRV.GetAddressOf()));
